function showVideoOnly() {
    ...
    // 加上新的連結
    video.innerHTML += `
      <a class="link-button full-width" href="https://tw.voicetube.com/" target="_blank">VoiceTube</a>
  ...
  function showAll() {
    ...
    magazine.innerHTML = `
        <h2>Magazine</h2>
        <a class="link-button full-width" href="https://magazine.english4u.net/Magdata/menu/ljkng" target="_blank">No.305 3月 4U</a>
        <a class="link-button full-width" href="https://magazine.english4u.net/Magdata/menu/hb0gp" target="_blank">No.306 4月 4U</a>
    `;

    original.innerHTML = `
        <h2>Original Content</h2>
        <a class="link-button full-width" href="https://mangadex.org/" target="_blank">MangaDex</a>
